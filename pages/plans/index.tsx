                    ...
                    <div className="h-96">
                        <h2 className="text-xl lg:text-2xl font-thin uppercase">Wacana</h2>
                        {
                            <div className="flex flex-col gap-2">
                                <h3 className="text-4xl lg:text-9xl font-medium tracking-wide uppercase">Pecundang {Plans.getCurrent()?.name}</h3>
                                <p> 
                        ...
                        <div className="flex flex-col gap-3 mt-3">
                        {
                            Plans.plans.map((e, index) => {
                                if(index < Plans.plans.length-1) {
                                    return (
                                        <PlanCard key={e.id} data={e} pecundangInstance={Plans} additionalClass="min-w-[50%]" />
                                    )
                                }
                            })
                        }
